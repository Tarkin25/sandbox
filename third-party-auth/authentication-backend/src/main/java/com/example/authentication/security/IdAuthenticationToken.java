...
public class IdAuthenticationToken implements Authentication {
    ...
    public static IdAuthenticationToken unauthenticated(String id) {
        return new IdAuthenticationToken(id, false, Collections.emptyList(), null);
    }

    public static IdAuthenticationToken authenticated(UserDetails userDetails) {
        return new IdAuthenticationToken(userDetails.getUsername(), true, userDetails.getAuthorities(), userDetails);
    }

    private IdAuthenticationToken(String id, boolean authenticated, Collection<? extends GrantedAuthority> authorities, UserDetails userDetails) {
        this.id = id;
